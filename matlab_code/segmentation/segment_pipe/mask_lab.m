function leaf_final = mask_lab(im)
% this is Derek code, I am just identifying the barcode, color tags pieces
% and saving as tiff file to further process the color tag for
% colora djustment with color bar.
%
% leaf_final is masked leaf, object_2 is bar code, object_3 (next to bar code one) and 
% object_4 (right most one tag) are color bar piece-1 and piece - 2 respectively.
%
% vatsa 
...
% we will have to change path, used in imwrite, when we will call it for batch processing.
% it is just to test and for further process the color bar for color
% adjustment
% 
% vatsa 10.14.2016
imwrite(object_2,'/athe/d/avi/test_output/barCode.tiff');               
                 
% object_3 is color bar i.e. just next to bar code one. 
%            
...
imwrite(object_3,'/athe/d/avi/test_output/leftPiece_colorBar.tiff');

% object_2 is bar code. 2nd next to bar code i.e. the right most one) 
%
%
...
object_4(:,:,3) = im(box_4(2):(box_4(2)+box_4(4)-1),...
 ...
 imwrite(object_4,'/athe/d/avi/test_output/rightPiece_colorBar.tiff');                

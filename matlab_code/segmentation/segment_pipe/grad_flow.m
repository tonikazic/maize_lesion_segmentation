function [sink_im,flow_im] = grad_flow(grad_x,grad_y,sink_mask,flow_mask,thresh)
...
for i=1:ht
    ...
    for j=1:wd
        ...
        % initiate coordinates at the current pixel    
        x = j; 
        y = i;
